...
表层定义见 [docs/schema.md](../schema.md) §3；DDL 真相源 [main_v4.sql](../../bili_unit/_db/ddl/main_v4.sql)。
...
uv run python -m bili_unit sync <uid> --parse-mode full        # 抓取后全量重物化 main DB（默认 incremental）
